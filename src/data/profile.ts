...
export const jobTitle = "Senior Backend Engineer";

export const summary =
  "Senior Backend Engineer with 8+ years of experience building scalable backend systems, " +
...
export const skillGroups: SkillGroup[] = [
  ...
  { title: "Backend", items: ["Spring", "Quarkus", "REST APIs", "Apache Kafka", "Maven", "Gradle"] },
